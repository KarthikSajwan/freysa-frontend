...
// Preload all textures to avoid loading delays
pages.forEach((page) => {
...
function Page({
  ...
  const [picture, picture2, pictureRoughness] = useTexture([
    ...
    ...(number === 0 || number === pages.length - 1
      ...
      : []),
  ]) as any; // We can refine these texture types if desired
  ...
  const manualSkinnedMesh = useMemo(() => {
    ...
    mesh.bind(skeleton);
    return mesh;
  }, [back, front, number, picture, picture2, pictureRoughness]);
  ...
  useFrame((_, delta) => {
    ...
    // Emissive intensity effect on hover
...
export function Book({ ...props }) {
  ...
  // Animate page transitions over time
  useEffect(() => {
